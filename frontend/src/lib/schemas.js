...
export const SCHEMAS = {
  ...
  circulation: {
    label: "Circulation",
    entryLabel: "Circulation Incharge",
    sections: [
      { id: "identification", title: "Identification", type: "grid", fields: [
        { key: "name", label: "Name" },
        { key: "designation", label: "Designation" },
...
// Merge default schema with admin override
export function mergeSchema(defaultSchema, override) {
  ...
  if (extras.length) {
    ...
    sections.push({ id: "_custom", title: "Custom Questions", type: "grid", fields: extraFields });
  }
